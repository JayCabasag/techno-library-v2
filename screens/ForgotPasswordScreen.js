    ...
    return (
      <View>
        <TextInput
          ...
          right={<TextInput.Icon style={{ height: 60, marginTop: 15 }} icon={!showRecoveryPassword ? 'eye-off' : 'eye'} onPress={() => setShowRecoveryPassword(prevState => !prevState)} />}
        />
        <TextInput
          mode='outlined'
          label={'New password'}
      ...
      <View style={styles.bodyContainer}>
        ...
        >
          ...
          }
          {
            ...
            >
              {isAuthenticating ? 'Please wait...' : 'Reset password'}
            </Button>) :
              (<Button
                mode="contained"
                style={styles.signInButton}
              ...
              >
                {isAuthenticating ? 'Please wait...' : 'Send to my Email'}
              </Button>)
          }
          <View
            style={{
